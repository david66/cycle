angular.module('cycleApp', ['restangular', 'ngRoute', 'ui.bootstrap', 'UserApp']).
    config(function ($routeProvider, RestangularProvider) {
        ...
        RestangularProvider.setBaseUrl('https://api.mongolab.com/api/1/databases/cycleit/collections');
